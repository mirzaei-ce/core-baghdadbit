...
unlocked to sign the Baghdadbit-Qt.app bundle.
...
allowing somebody to distribute a Baghdadbit-Qt.app or baghdadbit-qt-setup.exe with a valid
...
that the baghdadbit-qt.exe file inside the installer had not been tampered with.
