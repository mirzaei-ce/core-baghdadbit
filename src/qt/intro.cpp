...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/baghdadbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Baghdadbit Core"),
     ...
     * override -datadir in the baghdadbit.conf file in the default data directory
     * (to be consistent with baghdadbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
