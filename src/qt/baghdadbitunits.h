...
#ifndef BAGHDADBIT_QT_BAGHDADBITUNITS_H
#define BAGHDADBIT_QT_BAGHDADBITUNITS_H
...
/** Baghdadbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BaghdadbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BaghdadbitUnits(QObject *parent);

    /** Baghdadbit units.
      @note Source: https://en.baghdadbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BBT,
...
typedef BaghdadbitUnits::Unit BaghdadbitUnit;

#endif // BAGHDADBIT_QT_BAGHDADBITUNITS_H
