...
#ifndef BAGHDADBIT_TEST_SCRIPTNUM10_H
#define BAGHDADBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Baghdadbit Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BAGHDADBIT_TEST_BIGNUM_H
