Baghdadbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/baghdadbit/files/Baghdadbit/baghdadbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Baghdadbit
...
New/changed settings (command-line or baghdadbit.conf file)
--------------------------------------------------------
