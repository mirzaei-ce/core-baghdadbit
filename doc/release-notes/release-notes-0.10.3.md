Baghdadbit Core version 0.10.3 is now available from:

  <https://baghdadbit.org/bin/baghdadbit-core-0.10.3/>
...
(see https://github.com/baghdadbit/baghdadbit/pull/6793, as well as the 0.11.0
