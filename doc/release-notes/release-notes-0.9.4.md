Baghdadbit Core version 0.9.4 is now available from:

  https://baghdadbit.org/bin/0.9.4/
...
this update is incompatible with the Baghdadbit system and could lead to consensus
forks.

Baghdadbit Core released binaries from https://baghdadbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~baghdadbit/+archive/ubuntu/baghdadbit
- A third-party or self-compiled Baghdadbit Core

upgrade to Baghdadbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
