Baghdadbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/baghdadbit/files/Baghdadbit/baghdadbit-0.5.4/
...
http://gitorious.org/baghdadbit/baghdadbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Baghdadbit-Qt notifications under Growl 1.3.
Increase required age of Baghdadbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBaghdadbit properly when installing Baghdadbit-Qt over it. (Windows)
